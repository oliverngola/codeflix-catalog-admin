...
class CreateVideoWithoutMedia:
    ...
    def execute(self, input: Input) -> Output:
        ...
        notification.add_errors(self.validate_categories(input.categories))
        notification.add_errors(self.validate_genres(input.genres))
        notification.add_errors(self.validate_cast_members(input.cast_members))
